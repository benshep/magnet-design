...
class App(QtWidgets.QWidget):
    ...
    def appendControl(self, name, default, switch, units=None, checked=None, digits=2, step=1):
        ...
        self.controls.append((switch, control, checkbox if checked in (True, False) else None))
    ...
    def run_simulation(self):
        ...
        for switch, control, checkbox in self.controls:
        ...
        status_line = re.compile('Iteration (\d+)')
        failed = False
        ...
        polygons = np.loadtxt(r"magnet.csv", skiprows=1, usecols=range(1, 11), delimiter=',') * 1000
